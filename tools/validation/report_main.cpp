...
{det.cross_platform} of the {det.total} fingerprinted values are compared this way. The
other {det.tier1_only} are downstream of a finite difference and are held byte-identical
